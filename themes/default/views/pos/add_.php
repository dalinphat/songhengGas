                                    ...
                                    <div id="leftdiv">
                                        ...
                                        <div id="print">
                                            ...
                                            <div id="left-bottom">
                                                ...
                                                <input type="hidden" name="item_print" id="item_print" value="0" style="display: none;"/>
                                                    ...
                                                    <div class="font16">
                                                        <table class="table table-bordered table-condensed table-striped" style="font-size: 1.2em; font-weight: bold; margin-bottom: 0;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right" style="font-size:16px !important;"><span id="change_1" class="main_change_1">0.00</span></td>
                                                                <?php
                                                                $this->db->select('*');
                                                                $this->db->from('erp_currencies');
                                                                $this->db->where('code != "USD" and in_out = 1');
                                                            ...
                                                            <tr>
                                                                <td class="text-right" style="font-size:16px !important;"><span id="change" class="main_change">0.00</span></td>
                                                                <?php
                                                                $this->db->select('*');
                                                                $this->db->from('erp_currencies');
                                                                $this->db->where('code != "USD" and in_out = 1');
...
//////////////
                        ...
                        $('#amount_1, #amount_2, #amount_3, #amount_4, #amount_5, .currencies_payment').on('click', function() {
                            $(this).keyboard({
                                usePreview: false,
                                autoAccept: true,
                                alwaysOpen: true,
                        ...
                        $(document).on('keyup','#amount_1, #amount_2, #amount_3, #amount_4, #amount_5, .currencies_payment', function(){
                            ...
                            if(balance > 0){
                                ...
                                $('.main_change').text('0.00');
                                $('.main_change_1').text('0.00');
                                autoCalremain(formatDecimal(balance));
                                autoCalchange(0);
                            }else if(balance < 0){
                                balance  = balance * (-1);
                                var changekh = str[0] * (-1);
                                $('.main_change').text(formatMoney(balance));
                                $('.main_change_1').text(formatMoney(changekh));
