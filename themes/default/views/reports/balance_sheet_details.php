                ...
                <div class="table-scroll">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        foreach ($dataAsset->result() as $row) {
                            ...
                            foreach ($assetDetails->result() as $asD) {
                                ...
                                foreach ($new_billers as $bi2) {
                                    ...
                                    $b_amt = '';
                                    if ($asD->amount > 0) {
                                        $b_amt = number_format(abs($asD->amount), 2);
                                    } else {
                                        $b_amt = '( ' . number_format(abs($asD->amount), 2) . ' )';
                                    }
                                    if ($bi2_biller == $asD->biller_id) {
                                        ...
                                        echo '<td class="text-right"><div class="fix-text">' . number_format(0) . '</div></td>';
                                    }
                                }
                                ?>
                                <td class="text-right">
                                    <div class="fix-text"><b><?= $b_amt ?></b></div>
                                </td>
                                <?php
                                echo '</tr>';
                        ...
                        <tr>
                            ...
                            ?>
                            <td>
                                <div class="fix-text text-right"><b><?php echo $total_asset_display; ?></b></div>
                            </td>
                        </tr>
                        <!--- liabilities -->
                        <tr class="primary">
                        ...
                        foreach ($dataLiability->result() as $rowlia) {
                            //$total_liability += $rowlia->amount;
                                ...
                                $libDetails = $this->accounts_model->getBalanceSheetDetailPurByAccCodes($rowlia->account_code, '20,21', $from_date, json_decode($biller_id));
                            ...
                            foreach ($libDetails->result() as $libD) {
                                ...
                                <?php foreach ($new_billers as $bi2) {
                                    ...
                                    if ($bi2_biller == $libD->biller_id) {
                                        ...
                                        echo '<td><div class="fix-text text-right">' . 0 . '</div></td>';
                                    }
                                }
                                ...
                                ?>
                                <td>
                                    <div class="fix-text text-right"><b><?= $lib_amt_dis_in ?></b></div>
                                </td>
                                <?php
                                echo '</tr>';
                            ...
                            */
                            ...
                            echo '<td colspan="2"><div class="fix-text text-right"><b>' . number_format(abs($total_amt), 2) . '</b></div></td>';
                            echo '</tr>';
                        }
                        ...
                        <tr>
                            ...
                            */
                            ?>
                            <td>
                                <div class="fix-text text-right">
                                    <b><?php echo number_format(abs($total_liability), 2); ?></b></div>
                            </td>
                        </tr>
                        <!--- equities --->
                        <tr class="primary">
                        ...
                        ?>
                        <tr>
                            <td colspan="<?= $col1 ?>"><?= $retained->default_retained_earnings ?> - Retained Earnings
                            </td>
                            <?php
                            ...
                            for ($c = 0; $c < count($new_billers); $c++) {
                                ...
                                $total_retained += $total_per_retained;
                                $total_retained_arr[] = array(
                                    'biller_id' => $in_bill_id1,
                                ...
                                echo '<td class="right">' . $total_per_retained . '</td>';
                            }
                            ?>
                        ...
                        foreach ($dataEquity->result() as $rowequity) {
                            $total_equity += $rowequity->amount;
                                ...
                                $eqDetails = $this->accounts_model->getBalanceSheetDetailByAccCodess($rowequity->account_code, '30', $from_date, json_decode($biller_id));
                            ...
                            foreach ($eqDetails->result() as $eqD) {
                                ...
                                ?>
                                <td>
                                    <div class="fix-text text-right"><b><?= $eq_display1 ?></b></div>
                                </td>
                                <?php
                                echo '</tr>';
                            ...
                            $sum_eq_per_acc = array();
                            echo '<td colspan="2"><div class="fix-text text-right"><b>' . number_format(abs($total_amt_eq), 2) . '</b></div></td>';
                            echo '</tr>';
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="fix-text text-right"><b><?php echo $total_eq_sum; ?></b></div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            ?>
                            <td><div class="fix-text text-right"><b><?php echo number_format(abs($end_lib_eq),2);?></b></div></td>
    ...
    $(document).ready(function () {
        ...
        $("#biller-filter").on('click', function(event){
            ...
            if(hasCheck == true){
                ...
                var url = "<?php echo site_url('reports/balance_sheet_details/'.$from_date.'/'.$end.'/0/0') ?>" + '/' + encodeURIComponent(billers);
                window.location.href = "<?=site_url('reports/balance_sheet_details/'. $from_date .'/'.$end.'/0/0/')?>" + '/' + encodedName;
            }
        ...
        $('#pdf').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/balance_sheet_details/'. $from_date .'/'.$end.'/pdf/0/'.$biller_id)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/balance_sheet_details/'. $from_date .'/'.$end.'/0/xls/'.$biller_id)?>";
            return false;
        });
