        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/supplier_balance_report_r"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('end_date',$start_date2?date("d/m/Y", strtotime($end_date2)):'', 'class="form-control datetime" id="end_date"'); ?>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="POData" cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-bordered table-hover">
                        ...
                        {
                        $items          = $this->accounts_model->getApBySupplier_r($supplier->id,$start_date2, $end_date2);
                        if($start_date2)
                        {
...
//echo $project[1];
                        ?>
                                                <tr  class=''  style="cursor: pointer" id="row_click1" <?= $type  ?> >
                                                        ...
                                                        <td><?=$data->payment_term?$data->payment_term:'' ?></td>
                                                        <td><?= $aging ?></td>
