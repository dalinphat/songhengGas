...
<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getSupplierBalanceSummary_r').'/?v=1'.$v ?>',
...
<?php
echo form_open('reports/supplier_balance_summary_r', 'id="action-form"');
?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>Supplier Balance Summary</h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo form_open("reports/supplier_balance_summary_r"); ?>
                    <div class="row">
                        <div class="col-sm-4">
