...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Purchases_By_Item_Detail'); ?></h2>
        ...
        <div class="box-content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php echo form_open("reports/purchases_by_item_detail"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
//                $this->erp->print_arrays($product_detail);
                ...
                <table class="table table-bordered table-striped table-hover"  >
                    ...
                    foreach ($products_code as $cu){
                        $count++;
                        ?>
                    <tr style=""><td colspan="11" style=""><b><?php echo $cu->product_code;?></b></td></tr>

                        <?php

                        $product_detail = $this->reports_model->getPurchaseDataAll($cu->product_code,$customer_id, $reference_no, $biller_id,$start,$end,$pro_code1);
