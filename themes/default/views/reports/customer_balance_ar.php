...
<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sales/getCustomerBalance_ar/'.($warehouse_id ? $warehouse_id : '')).'/?v=1'.$v ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Customer_Balance_Summary'); ?></h2>
            ...
            <div class="col-lg-12">
				<p class="introtext"><?= lang('list_results'); ?></p>
				 <div id="form">
                            ...
                            <?php echo form_open("account/customer_balance_ar"); ?>
                            <div class="row">
								<div class="col-sm-4">
