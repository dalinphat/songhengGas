...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('Product_Movement_Detail') ; ?>
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="" class="table table-bordered table-hover table-striped table-condensed">
                        <thead>
                        <tr class="primary">
                            <th ><?= lang("type") ?></th>
                            <th><?= lang("date") ?></th>
                        ...
                        if(is_array($warehouses)){
                            foreach($warehouses as $warehouse){
                                ...
                                ?>
                                <tr>
                                    <td colspan="5" class="text-left" style="font-weight:bold; font-size:19px !important; color:green;">
                                        <?= lang("warehouse"); ?>
                                ...
                                foreach($categories AS $category){ ?>
                                    <tr>
                                        <td colspan="5" class="text-left" style="font-weight:bold; color:orange;">&nbsp;&nbsp;&nbsp;&nbsp;
                                            <?= lang("category"); ?>
                                            <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                    ...
                                    foreach ($products as $product) {
                                        if(!empty($product->product_id)){
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="5" class="left" style="font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$product->product_code?$product->product_code:$product->product_id?> <i class="fa fa-angle-double-right" aria-hidden="true"></i> <?=$product->product_name?> (<?=$product->un;?>)</td>
                                        ...
                                        foreach($prDetails as $pr)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?= $this->erp->formatQuantity($p_qty) ?></td>
                                            </tr>
                                            <?php
                                            $total_on_hand += $p_qty;
                                ...
                                <tr>
                                    <td class="right" colspan="4" style="font-weight:bold; color:green;"><span
