    ...
    <div class="body">
        <table  width="100%" class="tb_cus" style="overflow: hidden;border: 1px solid black">
            ...
            foreach ($rows as $row):
                ...
                $r++;
                if($r==21){
                    echo '<tr class="print" style="border-top: 1px solid black;"><td></td><td></td><td></td><td></td><td></td><td></td><td style=""><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br></td></tr>';
                    //echo '<tr class="print" style="border-bottom: 1px solid black"><td></td><td></td><td></td><td></td><td></td><td></td><td style=""><br><br></td></tr>';
                    echo '<tr class="print" style="border-bottom: 1px solid black;page-break-after: always"><td></td><td></td><td></td><td></td><td></td><td></td><td style=""><br><br></td></tr>';
