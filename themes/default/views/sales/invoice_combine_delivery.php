                            ...
                            <div class="row" style="margin-top: 0px !important;">
                                ...
                                <div  class="col-sm-7 col-xs-7 company_addr "  style="margin-top: -20px !important;">
                                        ...
                                        <div class="invoice" style="margin-top:20px;">
                                            <center>
                                                <h4 class="title">ប័ណ្ណបញ្ចេញទំនិញ</h4>
                                                <h4 class="title" style="margin-top: 3px;"></h4>
                                            </center>
                            ...
                            <div class="row" style="text-align: left;">
                                <div class="col-sm-7 col-xs-7">
                                    <table >
                                        ...
                                        <tr>
                                            <td>អ្នកដឹក / Driver </td>
                                            <td>:</td>
                                            <td><?= $uname->delivery_name; ?></td>
                                        </tr>
                                        <tr>
                                            <td>លេខអ្នកដឹក / Driver's Phone​  </td>
                                            <td>:</td>
                                            <td><?= $uname->phone; ?></td>
                                        </tr>
                                    </table>
                                ...
                                <div class="col-sm-5 col-xs-5">
                                    <table class="noPadding" border="none">
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><?= $this->erp->hrld($uname->date); ?></td>
                                        </tr>
                                        <tr>
...
<!--                        <th>អតិថិជន<br />--><?//= strtoupper(lang('Customer')) ?><!--</th>-->
<!--                        <th>អាសយដ្ឋាន<br />--><?//= strtoupper(lang('Location')) ?><!--</th>-->
                ...
                foreach ($cus as $custom){
                    $myString =$custom->address;
                    $myArray = explode('<br/>', $myString);

                if($custom->type == 'invoice'){
                    $item=$this->sales_model->getAllInvoiceDelivery($custom->customer_id,$custom->delivery_id);
                }else{
                    $item=$this->sales_model->getAllItemDelivery($custom->customer_id,$custom->delivery_id);
                }
                    ...
                    for($j=1;$j<=$k;$j++) {
                        if($pro_dis > 0 && $pro_tax >0) {
                            echo  '<tr class="border">
                                    <td colspan="7" height="34px" style="vertical-align: middle;font-weight: bold">'.$no.'</td>
                                </tr>';
                    ...
                    <td align="right">
                        <?php
                            if($invs->grand_total==0){echo "Free";}
                                ...
                                echo $this->erp->formatMoney($total_amount);
                            }
                        ?>
                    </td>
                </tr>
