        ...
        <table width="100%">
            <tr>
                <td>
                    ...
                    <h3 style="text-align: center; font-weight: bold"><?= $biller->company ?></h3>
                </td>
            </tr>
        </table>
...
//						}
                            ...
                            <!--                        <h1>--><?//= $col.'_----'.$rol; ?><!--</h1>-->
                            <tr style="border-bottom: 1px solid black">
                                <td rowspan="<?= $rol; ?>" colspan="<?= $col; ?>" style="vertical-align: top"><b>Note:</b><br><?= $this->erp->decode_html($customer->invoice_footer);  ?></td>
                            ...
                            <?php if ($inv->order_tax > 0) {
                                ...
                                echo '<tr><td colspan="' . $tcol . '" style="text-align:right; vertical-align:middle !important; padding-right:10px; font-weight: bold;">' . lang("អាករលើតម្លែបន្ថែម <span>". $vat_kh ."</span><br/><span style='font-size:12px'>". $inv->vat ."</span>") . '</td><td style="text-align:right; vertical-align:middle; padding-right:10px;font-weight:bold;">' . $this->erp->formatNumber($inv->order_tax) . '</td></tr>';
                            }
                            ?>
                            <?php
                            if($inv->order_tax>0||$inv->shipping>0||$inv->order_discount>0){
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-right:10px; font-weight:bold; vertical-align:middle!important;"><?= $this->erp->formatNumber(($total +  $inv->order_tax+$inv->shipping)-$inv->order_discount);?></td>
                                </tr>
                                <?php
                            }
                            ?>
                            ...
                            if($inv->paid>0){
                                ...
                                <tr style="border: 1px solid black">
                                    ...
                                    <td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;"><?= $this->erp->formatNumber($inv->grand_total-$inv->paid) ?></td>
                                </tr>
                                <?php
                            }
                            ?>
