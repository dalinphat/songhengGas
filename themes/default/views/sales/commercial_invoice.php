...
<div class="container" style="width: 821px;margin: 0 auto;">
    ...
    <div class="row">
        ...
        <hr style="border: 1px solid green !important; width: 80%;">

                    <div class="invoice" style="margin-top:10px;">
                        <center>
                            <h4 class="title">វិក័យបត្រ</h4>
                            <h4 class="title" style="margin-top: 3px;">Commerial Invoice</h4>
                        </center>
                    ...
                    <div class="row" style="text-align: left;">
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <table class="noPadding" border="none">
                                <tr>
                                    <td style="width: ;">លេខរអត្តសញ្ញាណកម្មសារពីពន្ធ /VAT TIN</td>
                                    <td style="width: 5%;">:</td>
