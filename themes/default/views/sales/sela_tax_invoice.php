        ...
        <div class="row" style="text-align: left;">
            ...
            <div class="col-sm-6 col-xs-6">
                <table class="noPadding" border="none">
                    <tr>
                        <td style="">លេខរអត្តសញ្ញាណកម្មសារពីពន្ធ /VAT TIN</td>
                        <td style="width: 5%;">:</td>
        ...
        <table class="table">
            ...
            foreach ($rows as $row) {
                ...
                <tr>
                    ...
                    <?php } ?>
                    <?php if ($total_tax != 0) {?>
                        <td style="vertical-align: middle; text-align: center;border-right: 1px solid black !important;border-bottom: 1px solid transparent !important;">
...
//                    }
            ...
            if ($invs->grand_total != $invs->total) { ?>
                <tr class="border-foot">
                    <td rowspan = "<?= $row; ?>" colspan="3" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;border-right: 1px solid #fff !important;">

                    </td>
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;border-left: 1px solid #FFF !important; border-bottom: 1px solid transparent !important;">តម្លៃសរុប  <?= strtoupper(lang('Taxable')) ?>
            ...
            <?php if ($invs->order_discount != 0) : ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;border-bottom: 1px solid transparent !important;">បញ្ចុះតម្លៃ / <?= strtoupper(lang('order_discount')) ?></td>
            ...
            <?php if ($invs->shipping != 0) : ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;border-bottom: 1px solid transparent !important;">ដឹកជញ្ជូន / <?= strtoupper(lang('shipping')) ?></td>
            ...
            <?php if ($invs->order_tax != 0) : ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;">អាករតម្លៃបន្ថែម ១០% VAT10%</td>
            ...
            <tr class="border-foot">
                <?php if ($invs->grand_total == $invs->total) { ?>
                    <td rowspan="<?= $row; ?>" colspan="3" style="border-right: 1px solid transparent !important; border-bottom: 1px solid #FFF !important;border-left: 1px solid #FFF !important;">

                    </td>
                <?php } ?>
                <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold; border-bottom: 1px solid transparent !important;border-left: 1px solid transparent !important;">តម្លៃសរុបរួមទាំងអាករ Grand Total
