    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                } else if(isset($duplicate_id)){
                    echo form_open_multipart("sales/add/0/0/0/".$duplicate_id, $attrib);
                }else{
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label for="warehouse" class="col-sm-4 control-label"><?= lang('warehouse'); ?></label>
                        ...
                        <div class="col-sm-8">
                            ...
                            echo form_dropdown('siwarehouse',$wh, '', 'id="siwarehouse" class="form-control input-tip select" style="width:100%;" ');
                            ?>
                        </div>
                    </div>
                    ...
                    <input type="hidden" id="si_warehouse" value=""/>
                </form>
            </div>
                ...
                if (slwarehouse = __getItem('slwarehouse')) {
                    ...
                    if (owner || admin) {
                        if (the_same_ware == true) {
                            ...
                            opt_first = "<?=$Settings->default_warehouse;?>";
                        } else {
                            opt_first = $('#slwarehouse option:first-child').val();
                    ...
                    __setItem('sowarehouse', opt_first);
                }
            }
        });
