                            ...
                            <ul>
                                ...
                                <li id="system_settings_closing_date">
                                    <a href="<?= site_url('system_settings/closing_date_list') ?>">
                                        <i class="fa fa-calendar"></i><span class="text"> <?= lang('closing_date'); ?></span>
                                    </a>
                                </li>
                                <?php if (POS) { ?>
                                    <!--  <li id="pos_settings">
                            ...
                            <ul>
                                ...
                                <!-- <li>
                                        ...
                                        <ul>
                                            ...
                                            <li id="account_customer_report_ar">
                                            ...
                                            <li id="account_customer_balance_ar">
                            ...
                            <ul>
                                ...
                                <li class="mm_sale_report">
                                    ...
                                    <ul>
                                        ...
                                        <li id="reports_sale_by_item_summary">
                                            <a href="<?= site_url('reports/sale_by_item_summary') ?>">
                                                <i class="fa fa-money"></i><span class="text"> <?= lang('Sale_By_Item_Summary'); ?></span>
                                            </a>
                                        </li>

                                        <li id="reports_sale_by_item_detail">
                                            <a href="<?= site_url('reports/sale_by_item_detail') ?>">
                                                <i class="fa fa-money"></i><span class="text"> <?= lang('Sale_By_Item_Detail'); ?></span>
                                            </a>
                                        </li>
                                        <li id="customer_balance_r">
                                            <a href="<?= site_url('account/customer_balance_r') ?>">
                                                <i class="fa fa-heart"></i><span class="text"> <?= lang('Customer_Balance'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="mm_purchase_report">
                                    ...
                                    <ul>
                                        ...
                                        <li id="reports_expense_report">
                                            <a href="<?= site_url('reports/purchases_by_item_summary') ?>">
                                                <i class="fa fa-users"></i><span class="text"> <?= lang('purchases_by_item_Summary'); ?></span>
                                            </a>
                                        </li>
                                        <li id="reports_expense_report">
                                            <a href="<?= site_url('reports/purchases_by_item_detail') ?>">
                                                <i class="fa fa-users"></i><span class="text"> <?= lang('purchases_by_item_detail'); ?></span>
                                            </a>
                                        </li>
                                        <!--
