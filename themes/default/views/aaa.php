                                        ...
                                        <ul>
                                            ...
                                            <li id="account_customer_report_ar">
                                                <a class="submenu" href="<?= site_url('account/customer_report_ar'); ?>">
                                                    <i class="fa fa-list"></i><span class="text"> <?= lang('customer_report_ar'); ?></span>
                                                </a>
                                            </li>
                                            <li id="account_customer_balance_ar">
                                                <a class="submenu" href="<?= site_url('account/customer_balance_ar'); ?>">
                                                    <i class="fa fa-list"></i><span class="text"> <?= lang('customer_balance_ar'); ?></span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul>
                                            ...
                                            <li id="reports_transaction_detail">
                                                <a href="<?= site_url('reports/transaction_detail') ?>">
                                                    <i class="fa fa-money"></i><span class="text"> <?= lang('transaction_detail_by_account'); ?></span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
													...
													<li id="reports_cash_chart">
														<a href="<?= site_url('reports/cash_chart') ?>">
                                                            ...
                                                            <li class="mm_profit_report">
                                                                <a class="dropmenu" href="#">
                                                                    <i class="fa fa-money"></i>
                                                                    <span class="text"> <?= lang('profit_reports'); ?> </span>
                                                                    <span class="chevron closed"></span>
                                                                </a>
                                                                <ul>
                                                                    <li id="reports_profit_loss">
