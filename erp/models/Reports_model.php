    ...
    public function getProductNames($term, $limit = 5)
{
    ...
    public function getProductCodeByIdWS($ware_house = null, $pro = null,$s_start = null, $e_end = null)
    {
...
//        }
    ...
    public function getSuppliersByID($product_id = null, $reference = null, $biller = null,$s_start = null, $e_end = null,$pro_code1=null)
    {
        $this->db->select('purchase_items.product_code,erp_products.name
       ')
            ->from('erp_purchase_items')
            ->join('erp_products', 'erp_products.code = erp_purchase_items.product_code','left')
            ->join('erp_purchases' , 'erp_purchases.id = erp_purchase_items.purchase_id','left')
...
//        }
    ...
    public function getProductCodeSummary($wh=null,$pr_c=null,$s_start=null,$e_end=null,$cus=null,$ref=null,$biller=null)
    {
...
//        };
    ...
    public function getAllProductCodeSummary($code = null,$wh=null)
    {
    ...
    public function getProductDataAll($wh_id=null,$pro_code = null, $customer = null,$reference = null,$s_start = null, $e_end = null,$pro_code1=null)
    {
        ...
        $q = $this->db->query("SELECT* 
                            ...
                            FROM
                                ...
                                LEFT JOIN `erp_companies` ON `erp_companies`.`id` = `erp_sales`.`biller_id` UNION ALL
                            SELECT
    ...
    public function getPurchaseDataAll_r($product_id = null,$reference = null,$s_start = null, $e_end = null,$billerss=null)
    {
        $this->db->select('erp_purchases.reference_no,
                                erp_purchases.id as pu_id,
                                "Purchase" as type,
