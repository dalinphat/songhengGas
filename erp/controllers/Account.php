  ...
  //       }
    ...
    function customer_balance_by_item()
    {
        ...
        if($this->input->post('saleman')){
            ...
            $this->data['sale_id'] = $this->input->post('saleman');
        }else{
            $this->data['sale_id'] = null;
        }
        ...
        $this->data['customers'] = $customers;
        $bc = array( array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('report')) );
        $meta = array('page_title' => lang('Sale by Customer Detail '), 'bc' => $bc);
        $this->page_construct('accounts/customer_balance_by_item', $meta, $this->data);
    }
    function customer_collection_detail()
    {
        if($this->input->post('start_date')){
            $start_date =  $this->erp->fld($this->input->post('start_date'));
            $this->data['start_date2'] = trim($start_date);
        ...
        $this->data['customers'] = $customers;
        $bc = array( array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('report')) );
        $meta = array('page_title' => lang('customer_collection_detail'), 'bc' => $bc);
        $this->page_construct('accounts/customer_collection_detail', $meta, $this->data);
    }
